                ...
                <div id="mydiv">
                  ...
                  //  include_once('/selects.js');
                    ...
                    if(isset($_POST['group_id']))
                    {
                        ...
                        $grou_id = htmlspecialchars($_POST['group_id']);
                        $discipline_id = htmlspecialchars($_POST['discipline_id']);
                        print_r($grou_id);
                    ...
                    FROM student INNER JOIN lab ON student.id = lab.student_id  WHERE student.grou_id=  ' . $grou_id .' AND  lab.discipline_id = ' . $discipline_id . '')) {
...
FROM mark RIGHT JOIN student ON mark.student_id = student.id 
             WHERE student.grou_id=6 AND mark.discipline_id = 2'))
