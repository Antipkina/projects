    ...
    <div class="block">
        <div class="text-content">
            ...
            <div class="hidden-print col-lg-7 col-lg-offset-2 col-md-7 col-sm-7 col-xs-7">
                ...
                <div class="icon col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    <a href="#"> <img src="/img/graphics.png"> </a>
                </div>
            </div>
...
FROM student INNER JOIN lab ON student.id = lab.student_id  WHERE student.grou_id=5 AND  lab.discipline_id = 1 ')){
            ...
            <div class="pagebreak">
                ...
                if ($result = mysqli_query($link, 'SELECT  attendance.student_id, attendance.id, attendance.note, attendance.data, attendance.note1, attendance.data1, attendance.note2, attendance.data2,  mark.student_id, mark.id, mark.discipline_id, mark.mark, student.fio 
FROM student LEFT JOIN mark ON student.id = mark.student_id 
            LEFT JOIN attendance ON mark.id = attendance.student_id  WHERE student.grou_id=5 AND mark.discipline_id = 1')) {
