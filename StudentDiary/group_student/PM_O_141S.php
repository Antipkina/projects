...
FROM student INNER JOIN lab ON student.id = lab.student_id  WHERE student.grou_id=3 ')){
...
FROM student LEFT JOIN attendance ON student.id = attendance.student_id  WHERE student.grou_id=3')) {
