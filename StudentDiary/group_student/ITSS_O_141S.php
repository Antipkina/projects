...
FROM student INNER JOIN lab ON student.id = lab.student_id  WHERE student.grou_id = 5 AND  lab.discipline_id = 1 ')){
            ...
            if ($result = mysqli_query($link, 'SELECT  attendance.student_id, attendance.id, attendance.note, attendance.data, attendance.note1, attendance.data1, attendance.note2, attendance.data2, student.login 
